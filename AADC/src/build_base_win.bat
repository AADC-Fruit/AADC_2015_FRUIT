...
cmake -G "%VS_STRING%" -DADTF_DIR="%ADTF_DIR%" -DCMAKE_INSTALL_PREFIX=../../bin -DQt_DIR="%QT_DIR%" -DQT_QMAKE_EXECUTABLE="%QMAKE_EXE%" "%SOURCE_DIR%" -DCMAKE_BUILD_TYPE=RelWithDebInfo ../adtfBase
