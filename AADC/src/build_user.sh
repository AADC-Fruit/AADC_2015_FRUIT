...
cmake -G "Unix Makefiles" -DCMAKE_TOOLCHAIN_FILE=$ADTF_TOOLCHAIN_FILE -DADTF_DIR=$ADTF_DIR -DQT_QMAKE_EXECUTABLE=$QMAKE_PATH -DCMAKE_BUILD_TYPE=RelWithDebInfo -DCMAKE_INSTALL_PREFIX=../../bin ../adtfUser

echo "build ..."
cmake --build . --target install --config RelWithDebInfo -- -j5
