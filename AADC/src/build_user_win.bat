...
set ADTF_DIR=C:/Program Files/ADTF/2.12.0
...
set BUILD_DIR=%1
if "%BUILD_DIR%"=="" set BUILD_DIR=_build_user
...
cmake -G "%VS_STRING%" -DADTF_DIR="%ADTF_DIR%" -DCMAKE_INSTALL_PREFIX=../../bin -DQt_DIR="%QT_DIR%" -DQT_QMAKE_EXECUTABLE="%QMAKE_EXE%" "%SOURCE_DIR%" -DCMAKE_BUILD_TYPE=RelWithDebInfo ../adtfUser
