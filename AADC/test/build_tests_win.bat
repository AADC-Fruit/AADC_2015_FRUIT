...
set BUILD_DIR=%1
if "%BUILD_DIR%"=="" set BUILD_DIR=_build_tests
...
cmake -G "%VS_STRING%" -DADTF_DIR="%ADTF_DIR%" -DCMAKE_INSTALL_PREFIX=../.. -DQt_DIR="%QT_DIR%" -DQT_QMAKE_EXECUTABLE="%QMAKE_EXE%" "%SOURCE_DIR%" -DCMAKE_BUILD_TYPE=RelWithDebInfo ..
