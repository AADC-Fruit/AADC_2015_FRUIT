...
#ifndef _TESTER_AADC_ARDUINO_COMM_HEADER_
#define _TESTER_AADC_ARDUINO_COMM_HEADER_
...
*
*/
DECLARE_TESTER_CLASS(cTesterAADCArduinoComm)
{
    BEGIN_TESTER_MAP(cTesterAADCArduinoComm)
        DECLARE_TESTER_FUNCTION(TestAcceleration)
        DECLARE_TESTER_FUNCTION(TestSteeringAngle)
		DECLARE_TESTER_FUNCTION(TestLights)
        DECLARE_TESTER_FUNCTION(TestAllActors)
    END_TESTER_MAP()
