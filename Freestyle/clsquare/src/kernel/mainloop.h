 ...
 * \li http://ml.informatik.uni-freiburg.de/research/clsquare
 *
...
//#ifdef FOUND_LIBDL
  bool load_controller_lib( const std::string& fname );
  bool load_controller_lib_allindir( const std::string& dirname );
//#endif
};
