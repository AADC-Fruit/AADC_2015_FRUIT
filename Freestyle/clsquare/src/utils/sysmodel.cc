#include "utils/sysmodel.h"
#include <iostream>
#include "global.h"

CLS::Util::SysModel::SysModel(int _xdim, double _delta_t, int _num_integration_steps, int _integration_mode, int _udim) 
...
void CLS::Util::SysModel::sysmodel_init(int _xdim, double _delta_t, int _num_integration_steps, int _integration_mode, int _udim)
{
...
void CLS::Util::SysModel::rkdumb(const double * vstart, double t_start, double t_stop, int n,
...
void CLS::Util::SysModel::rk4(const double * y, const double * dydx, double x, double interval,
...
bool CLS::Util::SysModel::sysmodel_nextState(const double * state, const double * action, double * nextState)
{
...
bool CLS::Util::SysModel::sysmodel_nextState(double t, const double * state, const double * action, double * nextState)
{
  switch (sysmodel_integration_mode) {
  case 1:
...
class dglSystem : public CLS::Util::SysModel {
 protected:
